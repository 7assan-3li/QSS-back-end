    ...
    <div class="flex flex-col md:flex-row justify-between items-center gap-8 text-start">
        <div class="text-start">
            <h3 class="font-black text-3xl flex items-center gap-4 text-start font-Cairo">
                <span class="w-16 h-16 bg-brand-primary-500/10 rounded-2xl flex items-center justify-center text-brand-primary-600 text-3xl font-Cairo shadow-lg shadow-brand-primary-500/5 whitespace-nowrap inline-flex items-center justify-center">👥</span>
                {{ __('سجل المستخدمين') }}
            </h3>
        ...
        <div class="card-premium glass-panel p-8 relative overflow-hidden group text-start">
            ...
            <div class="flex flex-col gap-2 relative z-10 text-start">
                ...
                <div class="flex items-baseline gap-3 text-start">
                    ...
                    <span class="text-[13px] font-black text-brand-primary-500 font-Cairo italic text-start">{{ __('مستخدم') }}</span>
                </div>
            </div>
        ...
        <div class="card-premium glass-panel p-8 relative overflow-hidden group font-Cairo text-start">
            ...
            <div class="flex flex-col gap-2 relative z-10 text-start">
                ...
                <div class="flex items-baseline gap-3 text-start">
                    ...
                    <span class="text-[13px] font-black text-brand-primary-500 italic text-start font-Cairo">{{ __('عضو جديد') }}</span>
                </div>
            </div>
