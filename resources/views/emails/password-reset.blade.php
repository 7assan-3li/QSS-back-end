                ...
                <tr>
                    <td style="padding:30px;color:#111827">
                        ...
                        <p style="font-size:15px;line-height:1.8;color:#374151">
                            لقد تلقينا طلباً لإعادة تعيين كلمة المرور الخاصة بحسابك في تطبيق <strong>QSS</strong>.
                            يرجى استخدام رمز استعادة كلمة المرور التالي لإتمام العملية:
                        </p>
                        ...
                        <p style="font-size:14px;color:#6b7280">
                            ...
                            إذا لم تطلب إعادة تعيين كلمة المرور، يمكنك تجاهل هذه الرسالة بأمان وسيبقى حسابك محمياً.
                        </p>
