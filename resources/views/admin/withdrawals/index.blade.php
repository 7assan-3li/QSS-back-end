    ...
    <div class="card-premium glass-panel rounded-[3.5rem] shadow-2xl border border-slate-100 dark:border-slate-800/50 overflow-hidden text-start">
        <div class="p-10 border-b border-slate-100 dark:border-slate-800/50 flex flex-col md:flex-row justify-between items-center gap-6 text-start">
            <div class="text-start">
                ...
                <p class="text-[10px] font-bold uppercase tracking-widest mt-1 text-start font-Cairo opacity-60">{{ __('تتبع التدفقات المالية الخارجة لضمان التزام المنصة تجاه الشركاء والمزودين.') }}</p>
            </div>
        </div>
        ...
        <div class="overflow-x-auto text-start">
            <table class="w-full text-start">
                <thead>
                    <tr class="bg-slate-50/50 dark:bg-slate-900/50 border-b border-slate-100 dark:border-slate-800 text-start font-Cairo tracking-widest uppercase text-[10px]">
                    ...
                    @forelse ($withdrawals as $w)
                        <tr class="hover:bg-slate-50/50 dark:hover:bg-slate-900/30 transition-colors group text-start">
                            <td class="px-8 py-6 text-start">
                                <div class="flex items-center gap-4 text-start">
                                    ...
                                    <div class="flex flex-col text-start font-Cairo">
                                        ...
                                        <span class="text-[9px] font-bold font-Cairo text-start opacity-60">{{ $w->user->email ?? __('لا يوجد بريد') }}</span>
                                    </div>
                                </div>
                            </td>
                            <td class="px-8 py-6 text-center text-start font-Cairo">
                                ...
                                <span class="text-[9px] font-black text-emerald-500 font-Cairo mr-1 opacity-80">{{ __('ر.س') }}</span>
                            </td>
                            <td class="px-8 py-6 text-start font-Cairo">
                                <span class="text-[10px] font-black font-Cairo leading-none opacity-60">{{ $w->created_at->format('Y-m-d H:i') }}</span>
                            </td>
