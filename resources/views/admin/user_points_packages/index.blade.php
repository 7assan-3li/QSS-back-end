    ...
    <div class="card-premium glass-panel rounded-[2rem] shadow-2xl border border-white dark:border-slate-800/50 overflow-hidden font-Cairo text-start">
        <div class="p-12 border-b border-slate-100 dark:border-slate-800/50 flex flex-col md:flex-row justify-between items-center gap-8 text-start">
            <div class="text-start">
                ...
                <p class="text-[10px] font-black uppercase tracking-[0.2em] mt-3 text-start font-Cairo opacity-60">{{ __('مراجعة وتأكيد عمليات الدفع لضمان تحديث أرصدة المستخدمين.') }}</p>
            </div>
        </div>
            ...
            <table class="w-full text-start border-collapse">
                <thead>
                    <tr class="bg-slate-50/40 dark:bg-slate-900/40 border-b border-slate-100 dark:border-slate-800 text-start font-Cairo">
                        ...
                        <th class="table-header-cell text-center">{{ __('المبلغ بالريال') }}</th>
                        ...
                        <tr class="hover:bg-brand-primary/[0.02] dark:hover:bg-brand-primary/[0.03] transition-all group font-Cairo text-start">
                            <td class="px-10 py-8 text-start">
                                <div class="flex items-center gap-5 text-start">
                                    ...
                                    <div class="flex flex-col text-start font-Cairo">
                                        ...
                                        <span class="text-[10px] font-bold font-mono text-start opacity-60">{{ $sub->user->email ?? __('لا يوجد بريد') }}</span>
                                    </div>
                                </div>
                            </td>
                            ...
                            <td class="px-10 py-8 text-center text-start font-Cairo">
                                <div class="flex items-center justify-center gap-2 font-mono text-start">
                                    ...
                                    <span class="text-[9px] font-black uppercase tracking-widest font-Cairo opacity-60">{{ __('ريال') }}</span>
                                </div>
                            </td>
                            <td class="px-10 py-8 text-start">
                            ...
                            <td class="px-10 py-8 text-start font-Cairo">
                                <span class="text-[10px] font-black font-mono leading-none text-start opacity-60">{{ $sub->created_at->format('Y-m-d H:i') }}</span>
                            </td>
