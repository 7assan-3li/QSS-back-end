...
<div class="max-w-5xl mx-auto py-10 px-4 font-Cairo animate-in fade-in slide-in-from-bottom-8 duration-700" 
    ...
    <div class="mb-10 flex items-center justify-between">
        ...
        <div class="flex items-center gap-3">
            ...
            <span class="text-[10px] font-black uppercase tracking-[0.3em] opacity-40">{{ __('تحديد بيانات الحملة') }}</span>
        </div>
    </div>
                    ...
                    <div class="relative group">
                        <div class="aspect-[16/9] rounded-3xl bg-slate-50 dark:bg-white/5 border-2 border-dashed border-slate-200 dark:border-white/10 flex flex-col items-center justify-center overflow-hidden transition-all duration-500 group-hover:border-brand-primary/50 relative">
                            ...
                            <div class="absolute inset-0 bg-black/40 opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-center justify-center backdrop-blur-sm">
                                <span class="px-4 py-2 bg-white text-brand-primary rounded-xl font-black text-[10px] uppercase shadow-lg">{{ __('تغيير الصورة') }}</span>
                            </div>
                ...
                <div class="card-premium p-10 transition-colors duration-500">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                        ...
                        <div class="md:col-span-2">
                            ...
                            <input type="text" name="title" value="{{ old('title', $advertisement->title) }}" placeholder="{{ __('مثال: عرض اليوم الوطني') }}"
                        ...
                        <div>
                            ...
                            <input type="number" name="sort_order" value="{{ old('sort_order', $advertisement->sort_order) }}" min="0"
...
@endforeach
                        ...
                        <div class="md:col-span-2 animate-in fade-in duration-500" x-show="targetType === 'external'">
                            ...
                            <input type="url" name="external_link" value="{{ $advertisement->external_link }}" placeholder="https://example.com/promotion"
                                   class="input-premium placeholder:opacity-30">
                        </div>
                    </div>
                </div>
                ...
                <div class="card-premium p-10 transition-colors duration-500">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                        <div>
                            ...
                            <input type="datetime-local" name="starts_at" value="{{ $advertisement->starts_at->format('Y-m-d\TH:i') }}"
                        ...
                        <div>
                            ...
                            <input type="datetime-local" name="ends_at" value="{{ $advertisement->ends_at ? $advertisement->ends_at->format('Y-m-d\TH:i') : '' }}"
                                   class="input-premium italic tracking-tight">
                        </div>
                    </div>
                </div>
