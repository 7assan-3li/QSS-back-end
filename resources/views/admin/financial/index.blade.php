...
<div class="max-w-7xl mx-auto space-y-16 mt-4 animate-fade-in text-start font-Cairo pb-32 print:p-0 print:m-0" x-data="{ activeTooltip: null, activeLedger: 'points' }">
    ...
    <div class="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-8 px-4 md:px-0 text-start group print:flex-row print:justify-between font-Cairo">
        <div class="text-start">
            <h3 class="font-black text-4xl flex items-center gap-6 text-start font-Cairo leading-tight">
                ...
                <div class="flex flex-col text-start">
                    ...
                    <span class="text-[10px] font-black text-slate-400 mt-2 tracking-[0.5em] uppercase opacity-60">Complete Financial Ledger Control</span>
                </div>
            </h3>
        </div>
        ...
        <div class="flex flex-wrap items-center gap-6 print:hidden">
            <form action="{{ route('admin.financial.index') }}" method="GET" class="glass-panel p-2.5 rounded-[2.5rem] border border-slate-100 dark:border-white/5 flex items-center gap-4 bg-white/60 dark:bg-slate-900/60 shadow-xl">
                <div class="flex items-center gap-3 px-5 border-l border-slate-200 dark:border-white/10 rtl:border-l-0 rtl:border-r font-Cairo">
                ...
                <button type="submit" class="bg-brand-primary text-white w-12 h-12 rounded-[1.3rem] flex items-center justify-center hover:scale-110 active:scale-95 transition-all shadow-xl shadow-brand-primary/30 font-Cairo">
            ...
            <button onclick="window.print()" class="h-16 px-8 bg-slate-900 hover:bg-black text-white rounded-[2rem] font-black text-[11px] uppercase tracking-[0.2em] flex items-center gap-4 transition-all shadow-2xl shadow-slate-900/20 italic group font-Cairo">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-10 px-4 md:px-0">
        ...
        <div class="card-premium glass-panel p-10 md:p-14 relative overflow-hidden group bg-emerald-500/5 dark:bg-emerald-500/[0.02] border border-emerald-500/10 shadow-emerald-500/5 text-start hover:scale-[1.01] transition-all duration-500"
            ...
            <div class="flex justify-between items-start relative z-10 text-start">
                <div class="text-start">
                    <div class="flex items-center gap-3">
                        ...
                        <span class="text-[11px] font-black text-emerald-600 uppercase tracking-[0.4em] italic">{{ __('إجمالي السيولة الداخلة المعتمدة') }}</span>
                    </div>
            ...
            <div class="grid grid-cols-3 gap-8 mt-16 pt-12 border-t border-emerald-500/10 relative z-10 text-start font-Cairo">
                <div class="text-start">
                    <p class="text-[10px] font-black text-slate-400 uppercase tracking-widest mb-4 opacity-70 group-hover:text-emerald-500 transition-colors uppercase leading-none">{{ __('باقات النقاط') }}</p>
                ...
                <div class="text-start border-x border-emerald-500/10 px-8">
                    <p class="text-[10px] font-black text-slate-400 uppercase tracking-widest mb-4 opacity-70 group-hover:text-emerald-500 transition-colors uppercase leading-none">{{ __('رسوم التوثيق') }}</p>
                ...
                <div class="text-start">
                    <p class="text-[10px] font-black text-slate-400 uppercase tracking-widest mb-4 opacity-70 group-hover:text-emerald-500 transition-colors uppercase leading-none">{{ __('العمولات المحصلة') }}</p>
        ...
        <div class="card-premium glass-panel p-10 md:p-14 relative overflow-hidden group bg-rose-500/5 dark:bg-rose-500/[0.02] border border-rose-500/10 shadow-rose-500/5 text-start hover:scale-[1.01] transition-all duration-500"
            ...
            <div class="flex justify-between items-start relative z-10 text-start font-Cairo">
                <div class="text-start">
                    <div class="flex items-center gap-3">
                        ...
                        <span class="text-[11px] font-black text-rose-600 uppercase tracking-[0.4em] italic">{{ __('إجمالي السيولة الخارجة المعتمدة') }}</span>
                    </div>
            ...
            <div class="mt-16 pt-12 border-t border-rose-500/10 relative z-10 text-start font-Cairo">
                 <div class="text-start font-Cairo">
                    <p class="text-[10px] font-black text-slate-400 uppercase tracking-widest mb-4 opacity-70 group-hover:text-rose-500 transition-colors uppercase leading-tight font-Cairo italic">{{ __('حوالات الكاش المكتملة لمزودي الخدمة') }}</p>
    ...
    <div class="px-4 md:px-0">
        <div class="card-premium glass-panel p-10 md:p-14 rounded-[3.5rem] border border-white/10 bg-white/40 dark:bg-slate-900/40 shadow-2xl relative overflow-hidden">
             ...
             <div class="flex flex-col md:flex-row justify-between items-start md:items-center mb-12 gap-6 text-start">
                  <div class="text-start font-Cairo">
                       ...
                       <p class="text-[10px] font-black text-slate-400 mt-2 uppercase tracking-[0.3em] font-Cairo opacity-50 italic">Monthly Cashflow Evolution Trend</p>
                  </div>
                  <div class="flex items-center gap-6 font-Cairo">
                       <div class="flex items-center gap-2">
                           <span class="w-3 h-3 bg-emerald-500 rounded-full"></span>
                           <span class="text-[10px] font-black opacity-60">{{ __('السيولة الداخلة') }}</span>
                       </div>
                       <div class="flex items-center gap-2">
                           <span class="w-3 h-3 bg-rose-500 rounded-full"></span>
                           <span class="text-[10px] font-black opacity-60">{{ __('السيولة الخارجة') }}</span>
                       </div>
                  </div>
             </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-10 px-4 md:px-0">
         <div class="card-premium glass-panel p-10 flex items-center justify-between border-l-8 border-indigo-500 bg-white/40 dark:bg-slate-900/40 text-start shadow-xl relative overflow-hidden group hover:scale-[1.02] transition-all duration-500"
            ...
            <div class="flex items-center gap-8 text-start relative z-10 font-Cairo">
                ...
                <div class="flex flex-col text-start">
                    <span class="text-[11px] font-black text-slate-400 uppercase tracking-[0.3em] mb-3 opacity-80 font-Cairo italic">{{ __('إجمالي النقاط المسجلة حالياً') }}</span>
                    <div class="flex items-baseline gap-4 text-start font-Cairo text-start">
                        ...
                        <span class="text-[11px] font-black opacity-30 uppercase tracking-widest leading-loose font-Cairo italic">{{ __('نقطة معلقة') }}</span>
                    </div>
                </div>
            </div>
         ...
         <div class="card-premium glass-panel p-10 flex items-center justify-between border-l-8 border-amber-500 bg-white/40 dark:bg-slate-900/40 text-start shadow-xl relative overflow-hidden group hover:scale-[1.02] transition-all duration-500"
            ...
            <div class="flex items-center gap-8 text-start relative z-10 font-Cairo">
                ...
                <div class="flex flex-col text-start ">
                    <span class="text-[11px] font-black text-slate-400 uppercase tracking-[0.3em] mb-3 opacity-80 font-Cairo italic">{{ __('نقاط المزودين القابلة للسحب كاش') }}</span>
                    <div class="flex items-baseline gap-4 text-start">
                        ...
                        <span class="text-[11px] font-black opacity-30 uppercase tracking-widest leading-loose font-Cairo italic">{{ __('التزام سيولة') }}</span>
                    </div>
                </div>
            </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-8 px-4 md:px-0">
        ...
        <div class="card-premium glass-panel p-10 relative overflow-hidden group border border-slate-100 dark:border-white/5 shadow-lg hover:border-{{ $item['col'] }}-500/50 transition-all duration-500 text-start"
            ...
            <div class="flex items-center justify-between mb-10 text-start relative z-10 font-Cairo">
                ...
                <span class="text-[9px] font-black text-slate-300 uppercase tracking-widest italic opacity-60 font-Cairo text-start">Source Breakdown</span>
            </div>

            <div class="text-start relative z-10">
                <h5 class="text-xs font-black italic text-slate-400 mb-3 font-Cairo">{{ $item['label'] }}</h5>
                <div class="flex items-baseline gap-3 text-start font-Cairo">
                    ...
                    <span class="text-[11px] font-black opacity-20 italic uppercase tracking-widest font-Cairo">{{ __('ر.س') }}</span>
                </div>
            </div>
            ...
            <div class="absolute inset-0 bg-slate-900/95 backdrop-blur-md p-8 flex flex-col justify-center items-center text-center text-white transition-all duration-500 group-hover:translate-y-0 translate-y-full z-50 pointer-events-none" 
                ...
                <p class="text-[11px] font-bold leading-relaxed italic font-Cairo">{{ $item['help'] }}</p>
            </div>
    ...
    <div class="px-4 md:px-0 space-y-12">
        <div class="text-start">
            <h4 class="text-3xl font-black italic font-Cairo flex items-center gap-6">
                <span class="w-4 h-14 bg-slate-900 rounded-2xl"></span>
                {{ __('مركز الأرشيف المالي الشامل') }}
            </h4>
            <p class="text-xs font-bold text-slate-400 mt-2 uppercase tracking-[0.4em] opacity-60">Full Granular Transaction Repository</p>
        </div>

        <div class="card-premium glass-panel rounded-[4rem] overflow-hidden shadow-2xl border border-white/10 bg-white/40 dark:bg-slate-900/40">
            <div class="flex items-center bg-slate-100/50 dark:bg-white/5 p-4 md:p-6 border-b border-white/10 overflow-x-auto gap-4 md:gap-8 font-Cairo">
                <button @click="activeLedger = 'points'" :class="activeLedger === 'points' ? 'bg-indigo-600 text-white shadow-lg scale-105' : 'bg-transparent text-slate-500 opacity-60 hover:opacity-100'" class="px-8 py-4 rounded-2xl text-[11px] font-black uppercase tracking-widest transition-all italic flex items-center gap-3 whitespace-nowrap">
                    ...
                    <div class="overflow-x-auto custom-scrollbar rounded-[2.5rem] border border-white/5 font-Cairo text-start">
                        <table class="w-full text-start">
                            <thead class="bg-indigo-500/5 border-b border-indigo-500/10">
                                <tr>
                                    <th class="table-header-cell px-10 py-7 text-start text-[10px] uppercase font-black opacity-40 italic">{{ __('المستفيد') }}</th>
                                    <th class="table-header-cell px-10 py-7 text-start text-[10px] uppercase font-black opacity-40 italic">{{ __('الباقة / القيمة') }}</th>
                                    <th class="table-header-cell px-10 py-7 text-start text-[10px] uppercase font-black opacity-40 italic">{{ __('رقم السند') }}</th>
                                    <th class="table-header-cell px-10 py-7 text-start text-[10px] uppercase font-black opacity-40 italic">{{ __('التاريخ') }}</th>
                                </tr>
                            </thead>
                                ...
                                <tr class="hover:bg-indigo-500/[0.03] transition-all group font-Cairo text-start">
                                    <td class="px-10 py-8 text-start font-Cairo">
                                        <div class="flex items-center gap-5">
                                            <div class="w-12 h-12 bg-slate-900 text-white rounded-xl flex items-center justify-center text-[11px] font-black shadow-lg">👤</div>
                                            <div class="flex flex-col text-start">
                                                <span class="text-[13px] font-black italic lrading-none">{{ $item->user->name ?? '---' }}</span>
                                                <span class="text-[9px] opacity-40 uppercase tracking-widest mt-1">ID #{{ $item->user_id }}</span>
                                            </div>
                                        </div>
                                    </td>
                                    <td class="px-10 py-8 text-start font-Cairo">
                                        <div class="flex flex-col">
                                            ...
                                            <span class="text-sm font-black text-emerald-500 font-mono mt-1">+{{ number_format($item->package->price ?? 0, 2) }} <span class="text-[9px] opacity-40 uppercase font-Cairo underline italic leading-tight">{{ __('ر.س') }}</span></span>
                                        </div>
                                    </td>
                                    <td class="px-10 py-8 text-start font-Cairo">
                                        <span class="px-4 py-2 bg-slate-100 dark:bg-white/5 rounded-xl text-[11px] font-black font-mono italic border border-white/5">REF: {{ $item->number_bond ?? 'DUE-' . $item->id }}</span>
                                    </td>
                                    <td class="px-10 py-8 text-start text-[10px] font-black text-slate-400 font-mono uppercase tracking-tighter">
                    ...
                    <div class="overflow-x-auto custom-scrollbar rounded-[2.5rem] border border-white/5">
                        <table class="w-full text-start">
                            <thead class="bg-amber-500/5 border-b border-amber-500/10">
                                <tr>
                                    <th class="table-header-cell px-10 py-7 text-start text-[10px] uppercase font-black opacity-40 italic">{{ __('المزود') }}</th>
                                    <th class="table-header-cell px-10 py-7 text-start text-[10px] uppercase font-black opacity-40 italic">{{ __('اشتراك التوثيق') }}</th>
                                    <th class="table-header-cell px-10 py-7 text-start text-[10px] uppercase font-black opacity-40 italic">{{ __('سند القبض') }}</th>
                                    <th class="table-header-cell px-10 py-7 text-start text-[10px] uppercase font-black opacity-40 italic">{{ __('التاريخ') }}</th>
                                </tr>
                            </thead>
                            <tbody class="divide-y divide-white/5">
                                ...
                                <tr class="hover:bg-amber-500/[0.03] transition-all group font-Cairo text-start">
                                    <td class="px-10 py-8 text-start">
                                        <div class="flex items-center gap-5">
                                            <div class="w-12 h-12 bg-amber-500 text-white rounded-xl flex items-center justify-center text-[11px] font-black shadow-lg">🛡️</div>
                                            <div class="flex flex-col text-start">
                                                <span class="text-[13px] font-black italic lrading-none">{{ $item->user->name ?? '---' }}</span>
                                                <span class="text-[9px] opacity-40 uppercase tracking-widest mt-1">Verified Expert</span>
                                            </div>
                                        </div>
                                    </td>
                                    <td class="px-10 py-8 text-start font-Cairo">
                                        <div class="flex flex-col">
                                            ...
                                            <span class="text-sm font-black text-emerald-500 font-mono mt-1">+{{ number_format($item->verificationPackage->price ?? 0, 2) }} <span class="text-[9px] opacity-40 uppercase font-Cairo underline italic leading-tight">{{ __('ر.س') }}</span></span>
                                        </div>
                                    </td>
                                    <td class="px-10 py-8 text-start font-Cairo">
                                        <span class="px-4 py-2 bg-slate-100 dark:bg-white/5 rounded-xl text-[11px] font-black font-mono italic border border-white/5">VRF: {{ $item->number_bond ?? 'BOND-' . $item->id }}</span>
                                    </td>
                                    <td class="px-10 py-8 text-start text-[10px] font-black text-slate-400 font-mono uppercase tracking-tighter">
                                        {{ $item->created_at->format('Y/m/d H:i') }}
                                    </td>
                    ...
                    <div class="overflow-x-auto custom-scrollbar rounded-[2.5rem] border border-white/5 font-Cairo text-start">
                        <table class="w-full text-start font-Cairo">
                            <thead class="bg-rose-500/5 border-b border-rose-500/10">
                                <tr>
                                    <th class="table-header-cell px-10 py-7 text-start text-[10px] uppercase font-black opacity-40 italic">{{ __('المزود المستلم') }}</th>
                                    <th class="table-header-cell px-10 py-7 text-start text-[10px] uppercase font-black opacity-40 italic">{{ __('المبلغ المصروف') }}</th>
                                    <th class="table-header-cell px-10 py-7 text-start text-[10px] uppercase font-black opacity-40 italic">{{ __('سند الصرف') }}</th>
                                    <th class="table-header-cell px-10 py-7 text-start text-[10px] uppercase font-black opacity-40 italic">{{ __('التاريخ') }}</th>
                                </tr>
                            </thead>
                            <tbody class="divide-y divide-white/5 font-Cairo text-start ">
                                ...
                                <tr class="hover:bg-rose-500/[0.03] transition-all group font-Cairo text-start">
                                    <td class="px-10 py-8 text-start font-Cairo">
                                        <div class="flex items-center gap-5">
                                            <div class="w-12 h-12 bg-rose-500 text-white rounded-xl flex items-center justify-center text-[11px] font-black shadow-lg">🏦</div>
                                            <div class="flex flex-col text-start">
                                                <span class="text-[13px] font-black italic lrading-none">{{ $item->user->name ?? '---' }}</span>
                                                <span class="text-[9px] opacity-40 uppercase tracking-widest mt-1">Payout Executed</span>
                                            </div>
                                        </div>
                                    </td>
                                    <td class="px-10 py-8 text-start font-Cairo">
                                        <span class="text-lg font-black text-rose-500 font-mono italic leading-none">-{{ number_format($item->amount, 2) }} <span class="text-[9px] opacity-40 uppercase font-Cairo underline italic leading-tight ">{{ __('ر.س') }}</span></span>
                                    </td>
                                    <td class="px-10 py-8 text-start font-Cairo">
                                        <span class="px-4 py-2 bg-slate-100 dark:bg-white/5 rounded-xl text-[11px] font-black font-mono italic border border-white/5">PAY: {{ $item->bond_number ?? 'WD-' . $item->id }}</span>
                                    </td>
                                    <td class="px-10 py-8 text-start text-[10px] font-black text-slate-400 font-mono uppercase tracking-tighter">
                                        {{ $item->created_at->format('Y/m/d H:i') }}
                                    </td>
    ...
    <div class="px-4 md:px-0">
        <div class="card-premium glass-panel p-16 rounded-[5rem] shadow-2xl relative border-2 border-brand-primary/10 overflow-hidden bg-white dark:bg-slate-900">
            <h4 class="text-3xl font-black font-Cairo text-start italic mb-12 flex items-center gap-6">
                <span class="w-2.5 h-12 bg-brand-primary rounded-xl font-Cairo"></span>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 text-start font-Cairo">
                <div class="text-start font-Cairo">
                    ...
                    <p class="text-[11px] font-bold text-slate-500 leading-relaxed font-Cairo italic">{{ __('كل نقطة مباعة هي التزام مالي بنكي. عند شراء "باقة نقاط"، تدخل السيولة للمنصة (Cash-in)، ولكنها تبقى "ديناً افتراضياً" حتى يتم استهلاكها أو سحبها.') }}</p>
                </div>
                 <div class="text-start font-Cairo">
                    <h6 class="text-base font-black italic text-amber-600 mb-5 font-Cairo">{{ __('رسوم التوثيق السيادية') }}</h6>
                    <p class="text-[11px] font-bold text-slate-500 leading-relaxed font-Cairo italic">{{ __('تعتبر رسوم التوثيق "ربحاً تشغيلياً مباشراً" للمنصة بنسبة 100%، حيث لا تقابلها التزامات دفع للمزودين، وتساهم في تغطية التكاليف.') }}</p>
                </div>
                 <div class="text-start font-Cairo">
                    <h6 class="text-base font-black italic text-emerald-600 mb-5 font-Cairo">{{ __('صافي الربح المحقق') }}</h6>
                    <p class="text-[11px] font-bold text-slate-500 leading-relaxed font-Cairo italic">{{ __('هو الحصاد الفعلي لمجهود المنصة؛ يُحسب من العمولات المقتطعة من العمليات الناجزة + عوائد التوثيق. هذا الرقم يعبر عن النمو الحقيقي.') }}</p>
                </div>
                 <div class="text-start font-Cairo">
                    <h6 class="text-base font-black italic text-rose-600 mb-5 font-Cairo">{{ __('إدارة مخاطر السحوبات') }}</h6>
                    <p class="text-[11px] font-bold text-slate-500 leading-relaxed font-Cairo italic">{{ __('نرصد كافة "النقاط القابلة للسحب" لضمان توفر رصيد بنكي موازٍ (Backing)، مما يضمن عدم حدوث فجوة في السيولة (Liquidity Gap).') }}</p>
                </div>
            </div>
        </div>
    </div>
