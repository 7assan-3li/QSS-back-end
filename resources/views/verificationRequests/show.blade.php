    ...
    <div class="flex flex-col md:flex-row justify-between items-center gap-8 text-start">
        ...
        <div class="flex items-center gap-4">
             <span class="px-6 py-2.5 rounded-2xl text-[10px] font-black uppercase tracking-[0.1em] font-Cairo text-start 
                ...
                <a href="{{ route('verification-requests.index') }}" class="w-14 h-14 bg-slate-100 dark:bg-slate-800 rounded-2xl flex items-center justify-center hover:bg-brand-primary hover:text-white transition-all shadow-sm border border-slate-200 dark:border-slate-800 font-Cairo opacity-60 hover:opacity-100">
        ...
        <div class="lg:col-span-2 space-y-12 text-start">
            ...
            <div class="card-premium glass-panel p-12 rounded-[2rem] shadow-[0_50px_100px_-20px_rgba(0,0,0,0.1)] relative border border-white dark:border-slate-800/50 text-start font-Cairo overflow-hidden">
                ...
                <div class="flex flex-col md:flex-row items-center gap-10 relative z-10 text-start">
                    ...
                    <div class="flex-grow text-center md:text-start font-Cairo">
                        ...
                        <div class="flex flex-wrap justify-center md:justify-start gap-6 text-start font-Cairo">
                            <span class="text-[11px] font-black flex items-center gap-3 font-mono text-start opacity-60">
                ...
                <div class="mt-16 space-y-8 relative z-10 text-start">
                    <div class="flex items-center gap-4 text-start font-Cairo">
                        ...
                        <span class="text-[9px] font-black uppercase tracking-[0.3em] font-Cairo text-start font-Cairo opacity-60">{{ __('محتوى الطلب') }}</span>
                    </div>
            ...
            <div class="grid grid-cols-2 md:grid-cols-4 gap-8 text-start">
                ...
                <div class="card-premium glass-panel p-8 rounded-[1.5rem] border border-white dark:border-slate-800/30 flex flex-col items-center gap-4 group hover:scale-[1.05] transition-all cursor-default shadow-sm text-start" dir="rtl">
                    ...
                    <span class="text-[9px] font-black uppercase tracking-[0.2em] text-center font-Cairo text-start opacity-60">{{ __('الخدمات النشطة') }}</span>
                </div>
                <!-- Total Requests -->
                <div class="card-premium glass-panel p-8 rounded-[1.5rem] border border-white dark:border-slate-800/30 flex flex-col items-center gap-4 group hover:scale-[1.05] transition-all cursor-default shadow-sm text-start" dir="rtl">
                    ...
                    <span class="text-[9px] font-black uppercase tracking-[0.2em] text-center font-Cairo text-start opacity-60">{{ __('إجمالي الطلبات') }}</span>
                </div>
                <!-- Completed -->
                ...
                <div class="card-premium glass-panel p-8 rounded-[1.5rem] border {{ $complaintsCount > 0 ? 'border-rose-500/30 bg-rose-50/20 dark:bg-rose-950/10' : 'border-slate-100 dark:border-slate-800/30' }} flex flex-col items-center gap-4 group hover:scale-[1.05] transition-all cursor-default shadow-sm text-start" dir="rtl">
                    <div class="w-14 h-14 {{ $complaintsCount > 0 ? 'bg-rose-500/10 text-rose-600' : 'bg-slate-100 dark:bg-slate-800' }} rounded-2xl flex items-center justify-center font-black text-2xl shadow-inner group-hover:rotate-6 transition-transform font-Cairo font-mono">
                         {{ $complaintsCount }}
                    </div>
                    <span class="text-[9px] font-black {{ $complaintsCount > 0 ? 'text-rose-500/80' : 'opacity-60' }} uppercase tracking-[0.2em] text-center font-Cairo text-start">{{ __('الشكاوى') }}</span>
                </div>
            </div>
        </div>
            ...
            <div class="card-premium glass-panel p-10 rounded-[2rem] shadow-2xl border border-white dark:border-slate-800/50 text-start font-Cairo">
                ...
                <div class="space-y-8 text-start">
                    <div class="flex justify-between items-center px-2 text-start font-Cairo">
                        <span class="text-[10px] font-black uppercase tracking-widest font-Cairo text-start opacity-60">{{ __('حالة العمولة') }}</span>
                    ...
                    <div class="flex justify-between items-center px-2 text-start font-Cairo">
                        <span class="text-[10px] font-black uppercase tracking-widest font-Cairo text-start opacity-60">{{ __('طلبات غير محصلة') }}</span>
