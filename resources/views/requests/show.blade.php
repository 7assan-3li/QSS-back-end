    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-12 text-start">
        ...
        <div class="lg:col-span-2 space-y-12 text-start">
            ...
            <div class="card-premium glass-panel p-12 rounded-[4rem] shadow-[0_50px_100px_-20px_rgba(0,0,0,0.1)] relative border border-[var(--glass-border)] text-start font-Cairo">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-y-12 gap-x-10 text-start">
                    ...
                    <div class="flex items-center gap-5 group text-start">
                        ...
                        <div class="flex flex-col text-start">
                            <span class="text-[12px] font-black text-[var(--text-muted)] uppercase tracking-[0.2em] mb-2 font-Cairo text-start">{{ __('مزود الخدمة') }}</span>
                            <span class="text-lg font-black text-[var(--main-text)] font-Cairo text-start">{{ $provider->name ?? __('غير محدد') }}</span>
                        </div>
                    </div>

                    <div class="flex items-center gap-5 group text-start">
                        <div class="w-14 h-14 bg-blue-500/10 text-blue-600 rounded-[1.3rem] flex items-center justify-center group-hover:scale-110 group-hover:rotate-6 transition-all duration-500 shadow-sm font-Cairo">
                    ...
                    <div class="flex items-center gap-5 group text-start">
                        ...
                        <div class="flex flex-col text-start">
                            <span class="text-[12px] font-black text-[var(--text-muted)] uppercase tracking-[0.2em] mb-2 font-Cairo text-start">{{ __('عمولة المنصة') }} ({{ round($request->commission_rate ?: 10) }}%)</span>
                             <div class="flex items-baseline gap-1 text-start">
                                <span class="text-2xl font-black text-brand-primary font-mono text-start">{{ number_format($request->getCommissionAmount(), 2) }}</span>
                                <span class="text-[13px] font-black text-[var(--text-muted)] font-Cairo text-start">YER</span>
                            </div>
                        </div>
                    </div>
