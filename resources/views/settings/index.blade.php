    ...
    <form action="{{ route('settings.update') }}" method="POST" class="space-y-16 text-start font-Cairo">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-12 text-start font-Cairo">
            @foreach ($settings as $setting)
                <div class="card-premium glass-panel p-12 rounded-[4.5rem] shadow-2xl relative border border-white dark:border-white/5 flex flex-col group hover:-translate-y-4 transition-all duration-1000 text-start overflow-hidden font-Cairo shadow-indigo-500/5">
                    <!-- Vector Glow Nodes -->
